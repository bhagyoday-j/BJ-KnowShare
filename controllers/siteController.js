...
const index = async (req,res) => {
  ...
  res.render('index', { paginatedNews , query: req.query, currentPath: '/' })
 }
...
const articleByCategories = async (req,res, next) => {
  ...
  res.render('category', { paginatedNews, category, query: req.query, currentPath: '/category/' + req.params.name })
 }
...
const singleArticle = async (req,res, next) => { 
  ...
  res.render('single', { singleNews, comments, currentPath: '/' })
}
...
const search = async (req,res) => {
  ...
  res.render('search', { paginatedNews, searchQuery, query: req.query, currentPath: '/search' })
 }
...
const author = async (req,res, next) => { 
  ...
  res.render('author', { paginatedNews, author, query: req.query, currentPath: '/' })
}
